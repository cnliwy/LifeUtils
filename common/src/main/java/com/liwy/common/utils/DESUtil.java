...
/**
 * Created by liwy on 2017/5/6.
 */

public class DESUtil {
    // 默认加密key
    public static String DEFAULT_ENCRYPT_KEY = "ecrfgcpa";
    public static void setPasswordCryptKey(String key){
        DEFAULT_ENCRYPT_KEY = key;
    }
    //基于key，解密数据     
    ...
    public static String encrypt(String value){
        ...
        try{
            ...
            result=toHexString(encrypt(value, DEFAULT_ENCRYPT_KEY)).toUpperCase();
        }catch(Exception ex){
        ex.printStackTrace();
        return "";
        }
